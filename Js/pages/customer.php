     ...
     <div class="container">
            <div class="row">
                ...
                <div class="col-sm-6 ">
                    ...
                    <div id="sign_in_customer">
                        <h1 class="sous_titre">Sign in</h1>
                        <form action="pages/<?php echo $log_page;?>" method="post">
                            <div class="form-group">
                                <label for="sig_name">Name:</label>
                                <input type="text" class="form-control"  name="sig_name" id="sig_name" value="<?php echo $sig_name;?>">
                                <p class="comments"><?php echo $sig_nameError?></p>
                            </div>
                            <div class="form-group">
                                <label for="sig_firstname">First Name:</label>
                                <input type="text" class="form-control" name="sig_firstname"  id="sig_firstname" value="<?php echo $sig_firstname;?>">
                                <p class="comments"><?php echo $sig_firstnameError?></p>
                            </div>
                            <div class="form-group">
                                <label for="sig_email">Email:</label>
                                <input type="email" class="form-control" name="sig_email"  id="sig_email" value="<?php echo $sig_email;?>">
                                <p class="comments"><?php echo $sig_emailError?></p>
                            </div>
                            <div class="form-group">
                                <label for="sig_tel">Tel:</label>
                                <input type="tel" class="form-control"  name="sig_tel" id="sig_tel" value="<?php echo $sig_tel;?>">
                                <p class="comments"><?php echo $sig_telError?></p>
                            </div>
                ...
                <div class="col-sm-6 ">
                    <div id="log_in_customer">
                        <h1 class="sous_titre">Log in</h1>
                        <form action="" method="post">
                                <div class="form-group" >
                                    <label for="log_email">Email:</label>
                                    <input type="email"  class="form-control" name="log_email"  id="log_email" value="<?php echo $log_email;?>">
                                     <p class="comments"><?php echo $log_emailError?></p>
                                </div>
                                <div class="form-group">
                                    <label for="password">Password:</label>
                                    <input type="password" class="form-control"  name="log_password" id="log_password" value="<?php echo $log_password;?>">
