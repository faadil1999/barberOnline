...
$emailTo =  $email_customer ;
        ...
        $headers = "Content-type: text/html; charset=UTF-8";
         ...
         $messageForMail  = 'Ваша просьба к парикмахеру '.$name_ba.' для '.$date.' в '.$time.' по адресу : <strong>'.$adresse.'</strong>  в <strong>'.$ville.' </strong>  <strong>ПРИНЯТО </strong>.';
...
?>
<script>
    alert('Телефон клиента<?php echo $tel ;?>.Перейти к Историческиx исследования ');
</script>
<a class="text-success" href="list_request_ba_ru.php"> Принято Нажмите здесь ...</a>
